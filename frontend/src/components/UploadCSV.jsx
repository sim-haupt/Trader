      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        <div className="ui-panel flex-1 border-dashed p-3">
          <input
            ...
            className="block w-full text-sm text-white/72 file:mr-4 file:rounded-[6px] file:border file:border-[var(--line)] file:bg-white file:px-4 file:py-2.5 file:text-sm file:font-semibold file:text-black hover:file:brightness-105"
          />
        </div>
        <button
          type="submit"
